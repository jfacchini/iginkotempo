...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.15 2010-02-12 12:24:35 GMT")
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_getelement(struct soap *soap, int *type)
{
	...
	case SOAP_TYPE_PointerTo_ns1__getStationsLesPlusProchesResponse:
		return soap_in_PointerTo_ns1__getStationsLesPlusProchesResponse(soap, NULL, NULL, "ns1:getStationsLesPlusProchesResponse");
	case SOAP_TYPE_PointerTo_ns1__getStationsLesPlusProches:
		return soap_in_PointerTo_ns1__getStationsLesPlusProches(soap, NULL, NULL, "ns1:getStationsLesPlusProches");
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "ns1:getStationsLesPlusProchesResponse"))
		{	*type = SOAP_TYPE__ns1__getStationsLesPlusProchesResponse;
			return soap_in__ns1__getStationsLesPlusProchesResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns1:getStationsLesPlusProches"))
		{	*type = SOAP_TYPE__ns1__getStationsLesPlusProches;
			return soap_in__ns1__getStationsLesPlusProches(soap, NULL, NULL, NULL);
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_putelement(struct soap *soap, const void *ptr, const char *tag, int id, int type)
{
	...
	case SOAP_TYPE__ns1__getStationsLesPlusProchesResponse:
		return ((_ns1__getStationsLesPlusProchesResponse *)ptr)->soap_out(soap, "ns1:getStationsLesPlusProchesResponse", id, NULL);
	case SOAP_TYPE__ns1__getStationsLesPlusProches:
		return ((_ns1__getStationsLesPlusProches *)ptr)->soap_out(soap, "ns1:getStationsLesPlusProches", id, NULL);
	...
	case SOAP_TYPE_PointerTo_ns1__getStationsLesPlusProchesResponse:
		return soap_out_PointerTo_ns1__getStationsLesPlusProchesResponse(soap, tag, id, (_ns1__getStationsLesPlusProchesResponse *const*)ptr, "ns1:getStationsLesPlusProchesResponse");
	case SOAP_TYPE_PointerTo_ns1__getStationsLesPlusProches:
		return soap_out_PointerTo_ns1__getStationsLesPlusProches(soap, tag, id, (_ns1__getStationsLesPlusProches *const*)ptr, "ns1:getStationsLesPlusProches");
	case SOAP_TYPE_PointerTo_ns1__getListeStationsParLigneResponse:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE__ns1__getTempsParStation:
		...
		break;
	case SOAP_TYPE__ns1__getStationsLesPlusProchesResponse:
		((_ns1__getStationsLesPlusProchesResponse *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE__ns1__getStationsLesPlusProches:
		((_ns1__getStationsLesPlusProches *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE__ns1__getListeStationsParLigneResponse:
	...
	case SOAP_TYPE___ns1__getTempsParStation:
		...
		break;
	case SOAP_TYPE___ns1__getStationsLesPlusProches:
		soap_serialize___ns1__getStationsLesPlusProches(soap, (const struct __ns1__getStationsLesPlusProches *)ptr);
		break;
	...
	case SOAP_TYPE_PointerTo_ns1__getTempsParStation:
		...
		break;
	case SOAP_TYPE_PointerTo_ns1__getStationsLesPlusProchesResponse:
		soap_serialize_PointerTo_ns1__getStationsLesPlusProchesResponse(soap, (_ns1__getStationsLesPlusProchesResponse *const*)ptr);
		break;
	case SOAP_TYPE_PointerTo_ns1__getStationsLesPlusProches:
		soap_serialize_PointerTo_ns1__getStationsLesPlusProches(soap, (_ns1__getStationsLesPlusProches *const*)ptr);
		break;
	case SOAP_TYPE_PointerTo_ns1__getListeStationsParLigneResponse:
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_instantiate(struct soap *soap, int t, const char *type, const char *arrayType, size_t *n)
{
	...
	case SOAP_TYPE__ns1__getStationsLesPlusProches:
		return (void*)soap_instantiate__ns1__getStationsLesPlusProches(soap, -1, type, arrayType, n);
	case SOAP_TYPE__ns1__getStationsLesPlusProchesResponse:
		return (void*)soap_instantiate__ns1__getStationsLesPlusProchesResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE__ns1__getTempsParStation:
	...
	case SOAP_TYPE___ns1__getStationsLesPlusProches:
		return (void*)soap_instantiate___ns1__getStationsLesPlusProches(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__getTempsParStation:
...
{	switch (p->type)
	...
	case SOAP_TYPE__ns1__getStationsLesPlusProches:
		if (p->size < 0)
			delete (_ns1__getStationsLesPlusProches*)p->ptr;
		else
			delete[] (_ns1__getStationsLesPlusProches*)p->ptr;
		break;
	case SOAP_TYPE__ns1__getStationsLesPlusProchesResponse:
		if (p->size < 0)
			delete (_ns1__getStationsLesPlusProchesResponse*)p->ptr;
		else
			delete[] (_ns1__getStationsLesPlusProchesResponse*)p->ptr;
		break;
	case SOAP_TYPE__ns1__getTempsParStation:
	...
	case SOAP_TYPE___ns1__getStationsLesPlusProches:
		if (p->size < 0)
			delete (struct __ns1__getStationsLesPlusProches*)p->ptr;
		else
			delete[] (struct __ns1__getStationsLesPlusProches*)p->ptr;
		break;
	case SOAP_TYPE___ns1__getTempsParStation:
...
void _ns1__getStationsLesPlusProchesResponse::soap_default(struct soap *soap)
{
	this->soap = soap;
	this->_ns1__getStationsLesPlusProchesResponse::__sizegetStationsLesPlusProchesReturn = 0;
	this->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn = NULL;
	/* transient soap skipped */
}

void _ns1__getStationsLesPlusProchesResponse::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
	if (this->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn)
	{	int i;
		for (i = 0; i < this->_ns1__getStationsLesPlusProchesResponse::__sizegetStationsLesPlusProchesReturn; i++)
		{
			soap_serialize_string(soap, this->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn + i);
		}
	}
	/* transient soap skipped */
}

int _ns1__getStationsLesPlusProchesResponse::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__getStationsLesPlusProchesResponse(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__getStationsLesPlusProchesResponse(struct soap *soap, const char *tag, int id, const _ns1__getStationsLesPlusProchesResponse *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__getStationsLesPlusProchesResponse), type))
		return soap->error;
	soap_element_result(soap, "-sizegetStationsLesPlusProchesReturn");
	if (a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn)
	{	int i;
		for (i = 0; i < a->_ns1__getStationsLesPlusProchesResponse::__sizegetStationsLesPlusProchesReturn; i++)
			if (soap_out_string(soap, "ns1:getStationsLesPlusProchesReturn", -1, a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn + i, ""))
				return soap->error;
	}
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
...
void *_ns1__getStationsLesPlusProchesResponse::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__getStationsLesPlusProchesResponse(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__getStationsLesPlusProchesResponse * SOAP_FMAC4 soap_in__ns1__getStationsLesPlusProchesResponse(struct soap *soap, const char *tag, _ns1__getStationsLesPlusProchesResponse *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__getStationsLesPlusProchesResponse *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__getStationsLesPlusProchesResponse, sizeof(_ns1__getStationsLesPlusProchesResponse), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE__ns1__getStationsLesPlusProchesResponse)
		{	soap_revert(soap);
			*soap->id = '\0';
			return (_ns1__getStationsLesPlusProchesResponse *)a->soap_in(soap, tag, type);
		}
	}
	struct soap_blist *soap_blist_getStationsLesPlusProchesReturn1 = NULL;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap->error == SOAP_TAG_MISMATCH && !soap_element_begin_in(soap, "ns1:getStationsLesPlusProchesReturn", 1, NULL))
			{	if (a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn == NULL)
				{	if (soap_blist_getStationsLesPlusProchesReturn1 == NULL)
						soap_blist_getStationsLesPlusProchesReturn1 = soap_new_block(soap);
					a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn = (char **)soap_push_block(soap, soap_blist_getStationsLesPlusProchesReturn1, sizeof(char *));
					if (a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn == NULL)
						return NULL;
					*a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn = NULL;
				}soap_revert(soap);
				if (soap_in_string(soap, "ns1:getStationsLesPlusProchesReturn", a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn, "xsd:string"))
				{	a->_ns1__getStationsLesPlusProchesResponse::__sizegetStationsLesPlusProchesReturn++;
					a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn = NULL;
					continue;
				}
			}
			/* transient soap skipped */
			soap_check_result(soap, "-sizegetStationsLesPlusProchesReturn");
			if (soap->error == SOAP_TAG_MISMATCH)
				soap->error = soap_ignore_element(soap);
			if (soap->error == SOAP_NO_TAG)
				break;
		...
		if (a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn)
			soap_pop_block(soap, soap_blist_getStationsLesPlusProchesReturn1);
		if (a->_ns1__getStationsLesPlusProchesResponse::__sizegetStationsLesPlusProchesReturn)
			a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn = (char **)soap_save_block(soap, soap_blist_getStationsLesPlusProchesReturn1, NULL, 1);
		else
		{	a->_ns1__getStationsLesPlusProchesResponse::getStationsLesPlusProchesReturn = NULL;
			if (soap_blist_getStationsLesPlusProchesReturn1)
				soap_end_block(soap, soap_blist_getStationsLesPlusProchesReturn1);
		}
		if (soap_element_end_in(soap, tag))
			return NULL;
	}
	else
	{	a = (_ns1__getStationsLesPlusProchesResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__getStationsLesPlusProchesResponse, 0, sizeof(_ns1__getStationsLesPlusProchesResponse), 0, soap_copy__ns1__getStationsLesPlusProchesResponse);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (a->_ns1__getStationsLesPlusProchesResponse::__sizegetStationsLesPlusProchesReturn < 1))
	{	soap->error = SOAP_OCCURS;
		return NULL;
	}
	return a;
...
int _ns1__getStationsLesPlusProchesResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, tag, SOAP_TYPE__ns1__getStationsLesPlusProchesResponse);
	if (this->soap_out(soap, tag?tag:"ns1:getStationsLesPlusProchesResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__getStationsLesPlusProchesResponse::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__getStationsLesPlusProchesResponse(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__getStationsLesPlusProchesResponse * SOAP_FMAC4 soap_get__ns1__getStationsLesPlusProchesResponse(struct soap *soap, _ns1__getStationsLesPlusProchesResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__getStationsLesPlusProchesResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 _ns1__getStationsLesPlusProchesResponse * SOAP_FMAC2 soap_instantiate__ns1__getStationsLesPlusProchesResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__getStationsLesPlusProchesResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE__ns1__getStationsLesPlusProchesResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new (_ns1__getStationsLesPlusProchesResponse);
		if (size)
			*size = sizeof(_ns1__getStationsLesPlusProchesResponse);
		((_ns1__getStationsLesPlusProchesResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)new (_ns1__getStationsLesPlusProchesResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(_ns1__getStationsLesPlusProchesResponse);
		for (int i = 0; i < n; i++)
			((_ns1__getStationsLesPlusProchesResponse*)cp->ptr)[i].soap = soap;
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (_ns1__getStationsLesPlusProchesResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__getStationsLesPlusProchesResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying _ns1__getStationsLesPlusProchesResponse %p -> %p\n", q, p));
	*(_ns1__getStationsLesPlusProchesResponse*)p = *(_ns1__getStationsLesPlusProchesResponse*)q;
}

void _ns1__getStationsLesPlusProches::soap_default(struct soap *soap)
{
	this->soap = soap;
	soap_default_string(soap, &this->_ns1__getStationsLesPlusProches::Longitute);
	soap_default_string(soap, &this->_ns1__getStationsLesPlusProches::Latitude);
	/* transient soap skipped */
}

void _ns1__getStationsLesPlusProches::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
	soap_serialize_string(soap, &this->_ns1__getStationsLesPlusProches::Longitute);
	soap_serialize_string(soap, &this->_ns1__getStationsLesPlusProches::Latitude);
	/* transient soap skipped */
}

int _ns1__getStationsLesPlusProches::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__getStationsLesPlusProches(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__getStationsLesPlusProches(struct soap *soap, const char *tag, int id, const _ns1__getStationsLesPlusProches *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__getStationsLesPlusProches), type))
		return soap->error;
	if (soap_out_string(soap, "ns1:Longitute", -1, &(a->_ns1__getStationsLesPlusProches::Longitute), ""))
		return soap->error;
	if (soap_out_string(soap, "ns1:Latitude", -1, &(a->_ns1__getStationsLesPlusProches::Latitude), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}

void *_ns1__getStationsLesPlusProches::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__getStationsLesPlusProches(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__getStationsLesPlusProches * SOAP_FMAC4 soap_in__ns1__getStationsLesPlusProches(struct soap *soap, const char *tag, _ns1__getStationsLesPlusProches *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__getStationsLesPlusProches *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__getStationsLesPlusProches, sizeof(_ns1__getStationsLesPlusProches), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE__ns1__getStationsLesPlusProches)
		{	soap_revert(soap);
			*soap->id = '\0';
			return (_ns1__getStationsLesPlusProches *)a->soap_in(soap, tag, type);
		}
	}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_Longitute1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns1:Longitute", &(a->_ns1__getStationsLesPlusProches::Longitute), "xsd:string"))
				{	soap_flag_Longitute1--;
					continue;
				}
			if (soap_flag_Latitude1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns1:Latitude", &(a->_ns1__getStationsLesPlusProches::Latitude), "xsd:string"))
				{	soap_flag_Latitude1--;
					continue;
				}
			/* transient soap skipped */
	...
	{	a = (_ns1__getStationsLesPlusProches *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__getStationsLesPlusProches, 0, sizeof(_ns1__getStationsLesPlusProches), 0, soap_copy__ns1__getStationsLesPlusProches);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_Longitute1 > 0 || soap_flag_Latitude1 > 0))
	{	soap->error = SOAP_OCCURS;
		return NULL;
	}
	return a;
...
int _ns1__getStationsLesPlusProches::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, tag, SOAP_TYPE__ns1__getStationsLesPlusProches);
	if (this->soap_out(soap, tag?tag:"ns1:getStationsLesPlusProches", id, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__getStationsLesPlusProches::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__getStationsLesPlusProches(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__getStationsLesPlusProches * SOAP_FMAC4 soap_get__ns1__getStationsLesPlusProches(struct soap *soap, _ns1__getStationsLesPlusProches *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__getStationsLesPlusProches(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 _ns1__getStationsLesPlusProches * SOAP_FMAC2 soap_instantiate__ns1__getStationsLesPlusProches(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__getStationsLesPlusProches(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE__ns1__getStationsLesPlusProches, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new (_ns1__getStationsLesPlusProches);
		if (size)
			*size = sizeof(_ns1__getStationsLesPlusProches);
		((_ns1__getStationsLesPlusProches*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)new (_ns1__getStationsLesPlusProches[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(_ns1__getStationsLesPlusProches);
		for (int i = 0; i < n; i++)
			((_ns1__getStationsLesPlusProches*)cp->ptr)[i].soap = soap;
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (_ns1__getStationsLesPlusProches*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__getStationsLesPlusProches(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying _ns1__getStationsLesPlusProches %p -> %p\n", q, p));
	*(_ns1__getStationsLesPlusProches*)p = *(_ns1__getStationsLesPlusProches*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__getStationsLesPlusProches(struct soap *soap, struct __ns1__getStationsLesPlusProches *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__getStationsLesPlusProches = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__getStationsLesPlusProches(struct soap *soap, const struct __ns1__getStationsLesPlusProches *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTo_ns1__getStationsLesPlusProches(soap, &a->ns1__getStationsLesPlusProches);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__getStationsLesPlusProches(struct soap *soap, const char *tag, int id, const struct __ns1__getStationsLesPlusProches *a, const char *type)
{
	if (soap_out_PointerTo_ns1__getStationsLesPlusProches(soap, "ns1:getStationsLesPlusProches", -1, &a->ns1__getStationsLesPlusProches, ""))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__getStationsLesPlusProches * SOAP_FMAC4 soap_in___ns1__getStationsLesPlusProches(struct soap *soap, const char *tag, struct __ns1__getStationsLesPlusProches *a, const char *type)
{
	size_t soap_flag_ns1__getStationsLesPlusProches = 1;
	short soap_flag;
	a = (struct __ns1__getStationsLesPlusProches *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__getStationsLesPlusProches, sizeof(struct __ns1__getStationsLesPlusProches), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__getStationsLesPlusProches(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__getStationsLesPlusProches && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__getStationsLesPlusProches(soap, "ns1:getStationsLesPlusProches", &a->ns1__getStationsLesPlusProches, ""))
				{	soap_flag_ns1__getStationsLesPlusProches--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_flag)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__getStationsLesPlusProches(struct soap *soap, const struct __ns1__getStationsLesPlusProches *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__getStationsLesPlusProches(soap, tag?tag:"-ns1:getStationsLesPlusProches", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__getStationsLesPlusProches * SOAP_FMAC4 soap_get___ns1__getStationsLesPlusProches(struct soap *soap, struct __ns1__getStationsLesPlusProches *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__getStationsLesPlusProches(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__getStationsLesPlusProches * SOAP_FMAC2 soap_instantiate___ns1__getStationsLesPlusProches(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__getStationsLesPlusProches(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__getStationsLesPlusProches, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new (struct __ns1__getStationsLesPlusProches);
		if (size)
			*size = sizeof(struct __ns1__getStationsLesPlusProches);
	}
	else
	{	cp->ptr = (void*)new (struct __ns1__getStationsLesPlusProches[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct __ns1__getStationsLesPlusProches);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct __ns1__getStationsLesPlusProches*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__getStationsLesPlusProches(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__getStationsLesPlusProches %p -> %p\n", q, p));
	*(struct __ns1__getStationsLesPlusProches*)p = *(struct __ns1__getStationsLesPlusProches*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__getStationsLesPlusProchesResponse(struct soap *soap, _ns1__getStationsLesPlusProchesResponse *const*a)
{
	if (!soap_reference(soap, *a, SOAP_TYPE__ns1__getStationsLesPlusProchesResponse))
		(*a)->soap_serialize(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__getStationsLesPlusProchesResponse(struct soap *soap, const char *tag, int id, _ns1__getStationsLesPlusProchesResponse *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE__ns1__getStationsLesPlusProchesResponse);
	if (id < 0)
		return soap->error;
	return (*a)->soap_out(soap, tag, id, type);
}

SOAP_FMAC3 _ns1__getStationsLesPlusProchesResponse ** SOAP_FMAC4 soap_in_PointerTo_ns1__getStationsLesPlusProchesResponse(struct soap *soap, const char *tag, _ns1__getStationsLesPlusProchesResponse **a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
		if (!(a = (_ns1__getStationsLesPlusProchesResponse **)soap_malloc(soap, sizeof(_ns1__getStationsLesPlusProchesResponse *))))
			return NULL;
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = (_ns1__getStationsLesPlusProchesResponse *)soap_instantiate__ns1__getStationsLesPlusProchesResponse(soap, -1, soap->type, soap->arrayType, NULL)))
			return NULL;
		(*a)->soap_default(soap);
		if (!(*a)->soap_in(soap, tag, NULL))
			return NULL;
	...
	{	_ns1__getStationsLesPlusProchesResponse ** p = (_ns1__getStationsLesPlusProchesResponse **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__getStationsLesPlusProchesResponse, sizeof(_ns1__getStationsLesPlusProchesResponse), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__getStationsLesPlusProchesResponse(struct soap *soap, _ns1__getStationsLesPlusProchesResponse *const*a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_PointerTo_ns1__getStationsLesPlusProchesResponse);
	if (soap_out_PointerTo_ns1__getStationsLesPlusProchesResponse(soap, tag?tag:"ns1:getStationsLesPlusProchesResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 _ns1__getStationsLesPlusProchesResponse ** SOAP_FMAC4 soap_get_PointerTo_ns1__getStationsLesPlusProchesResponse(struct soap *soap, _ns1__getStationsLesPlusProchesResponse **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTo_ns1__getStationsLesPlusProchesResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__getStationsLesPlusProches(struct soap *soap, _ns1__getStationsLesPlusProches *const*a)
{
	if (!soap_reference(soap, *a, SOAP_TYPE__ns1__getStationsLesPlusProches))
		(*a)->soap_serialize(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__getStationsLesPlusProches(struct soap *soap, const char *tag, int id, _ns1__getStationsLesPlusProches *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE__ns1__getStationsLesPlusProches);
	if (id < 0)
		return soap->error;
	return (*a)->soap_out(soap, tag, id, type);
}

SOAP_FMAC3 _ns1__getStationsLesPlusProches ** SOAP_FMAC4 soap_in_PointerTo_ns1__getStationsLesPlusProches(struct soap *soap, const char *tag, _ns1__getStationsLesPlusProches **a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
		if (!(a = (_ns1__getStationsLesPlusProches **)soap_malloc(soap, sizeof(_ns1__getStationsLesPlusProches *))))
			return NULL;
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = (_ns1__getStationsLesPlusProches *)soap_instantiate__ns1__getStationsLesPlusProches(soap, -1, soap->type, soap->arrayType, NULL)))
			return NULL;
		(*a)->soap_default(soap);
		if (!(*a)->soap_in(soap, tag, NULL))
			return NULL;
	...
	{	_ns1__getStationsLesPlusProches ** p = (_ns1__getStationsLesPlusProches **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__getStationsLesPlusProches, sizeof(_ns1__getStationsLesPlusProches), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__getStationsLesPlusProches(struct soap *soap, _ns1__getStationsLesPlusProches *const*a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_PointerTo_ns1__getStationsLesPlusProches);
	if (soap_out_PointerTo_ns1__getStationsLesPlusProches(soap, tag?tag:"ns1:getStationsLesPlusProches", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 _ns1__getStationsLesPlusProches ** SOAP_FMAC4 soap_get_PointerTo_ns1__getStationsLesPlusProches(struct soap *soap, _ns1__getStationsLesPlusProches **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTo_ns1__getStationsLesPlusProches(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
